;;; ef-reverie-2-theme.el --- Legible light theme with gold and nuanced colors -*- lexical-binding:t -*-
...
(defconst ef-reverie-2-palette-partial
  '((cursor "#9d5744")
    (bg-main "#e8e0e0")
    (bg-dim "#e5d6d4")
    (bg-alt "#d9cac8")
...
(defconst ef-reverie-2-palette-mappings-partial
  '((err magenta-warmer)
...
(defcustom ef-reverie-2-palette-overrides nil
  "Overrides for `ef-reverie-2-palette'.
...
(defconst ef-reverie-2-palette
  (modus-themes-generate-palette
   ef-reverie-2-palette-partial
   nil
   nil
   (append ef-reverie-2-palette-mappings-partial ef-themes-palette-common)))
...
(modus-themes-theme
 ...
 'light
 'ef-reverie-2-palette
 nil
 'ef-reverie-2-palette-overrides
 'ef-themes-custom-faces)

;;; ef-reverie-2-theme.el ends here
